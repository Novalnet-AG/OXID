...
$aLang = [
    ...
    'NOVALNET_CREDITCARD_TYPE'                          => 'Credit Card type',
    ...
    'NOVALNET_NEW_CARD_DETAILS'                         => 'Add new card details for later purchases',
    'NOVALNET_GIVEN_CARD_DETAILS'                       => 'Given card details',
    'NOVALNET_NEW_ACCOUNT_DETAILS'                      => 'Add new account details for later purchases',
    ...
    'NOVALNET_CC_SAVE_CARD_DATA'                        => 'I want to save my card details for later purchases',
    'NOVALNET_SEPA_SAVE_CARD_DATA'                      => 'I want to save my account details for later purchases',
    'NOVALNET_PAYPAL_SAVE_CARD_DATA'                    => 'Save my PayPal account details for later purchases',
    'NOVALNET_CC_INVALID_DETAILS'                       => 'Your credit card details are invalid',
    ...
    'NOVALNET_GUARANTEE_AMOUNT_ERROR_MESSAGE'           => 'Minimum order amount must be ',
    ...
    'NOVALNET_CRITICAL_ERROR_MESSAGE2'                  => ' : order not found for TID: %s',
    'NOVALNET_CRITICAL_MESSAGE_SUBJECT'                 => 'Dear Technic team,<br/><br/>Please evaluate this transaction and contact our Technic team and Backend team at Novalnet.<br/><br/>',
    ...
    'NOVALNET_PAYMENT_GUARANTEE_DOB_ERROR_MSG'  => 'Please enter valid birth date',
];
?>
