...
<div id="nn_new_account_div" style=[{$aSepaDetails.new_details_style}]>
	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			<input type="text" class="form-control" size="20" id="novalnet_sepa_acc_no" name="dynvalue[novalnet_sepa_iban]" value= "[{$smarty.session.refillSepaiban}]" autocomplete="off" onkeypress="return NovalnetUtility.formatIban(event,'novalnet_sepa_bic_div');" onchange="return NovalnetUtility.formatIban(event,'novalnet_sepa_bic_div');"><span id="novalnet_sepa_iban_span"></span>
		</div>
	</div>
	<div class="form-group" id="novalnet_sepa_bic_div" style ="display:none;">
		...
		<div class="col-lg-9">
			<input type="text" class="form-control" size="20" id="novalnet_sepa_bic" name="dynvalue[novalnet_sepa_bic]" autocomplete="off" onkeypress="return NovalnetUtility.formatBic(event);" onchange="return NovalnetUtility.formatBic(event);">
		</div>
	</div>
	[{if !empty($smarty.session.blGuaranteeEnablednovalnetsepa) && empty($smarty.session.blGuaranteeForceDisablednovalnetsepa) && $oView->getCompanyFieldValue() == '' }]
	<div class="form-group">
