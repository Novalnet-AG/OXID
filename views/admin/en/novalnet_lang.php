...
$aLang = [
    ...
    'NOVALNET_CALLBACK_INSTALMENT_MESSAGE'              => '<br><br>A new instalment has been received for the Transaction ID:%s with amount %s. The new instalment transaction ID is: %s',
    'NOVALNET_CALLBACK_INSTALMENT_CANCEL_MESSAGE'       => '<br>Instalment has been cancelled for the TID %s on %s',
    'NOVALNET_PAYMENT_REMAINTER1_MESSAGE'               => '<br>Payment Reminder 1 has been sent to the customer',
    'NOVALNET_PAYMENT_REMAINTER2_MESSAGE'               => '<br>Payment Reminder 2 has been sent to the customer',
    'NOVALNET_COLLECTION_AGENCY_MESSAGE'                => '<br>The transaction has been submitted to the collection agency. Collection Reference: %s',
    ...
    'NOVALNET_CALLBACK_UPDATE_STATUS_ONHOLD'            => '<br>The transaction status has been changed from pending to on hold for the TID: %s on %s',
    'NOVALNET_CALLBACK_UPDATE_STATUS_UPDATE'            => '<br>The transaction has been updated succesfully for the TID %s on %s',
    'NOVALNET_CALLBACK_UPDATE_DUEDATE'                  => '<br>Transaction updated successfully for the TID %s with amount %s and due date %s',
    'NOVALNET_CALLBACK_UPDATE_AMOUNT'                   => '<br>Transaction updated successfully for the TID %s with amount %s',
    ...
    'NOVALNET_PAYMENT_REFERENCE_1'                      => '<br>Payment Reference 1: %s',
    ...
    'NOVALNET_CHECK_HASH_FAILED_ERROR'                  => '<br>While redirecting some data has been changed. The hash check failed',
