...
$aLang = [
    ...
    'NOVALNET_PRODUCT_ACTIVATION_KEY_DESCRIPTION' => 'Get your Product activation key from the <a style="font-weight: bold; color:#0080c9;" href="https://admin.novalnet.de" target="_blank">Novalnet Admin Portal</a>: Projects > Choose your project > API credentials > API Signature (Product activation key)',
    ...
    'NOVALNET_ADMIN_UPDATE_VERSION'                   => '<h2><b>Novalnet Payment Module V11.5.0</b></h2>',
