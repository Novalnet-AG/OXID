...
<input type="hidden" id="getUrl" name="getUrl" value="[{$oView->getNovalnetShopUrl()}]">
<input type="hidden" id="ipErrorOne" name="ipErrorOne" value="[{ oxmultilang ident='NOVALNET_CONFIG_IP_ERROR1' }]">
<input type="hidden" id="ipErrorTwo" name="ipErrorTwo" value="[{ oxmultilang ident='NOVALNET_CONFIG_IP_ERROR2' }]">
...
<div style="padding:20px;" id="novalnet_config">
    <form name="myedit" id="myedit" enctype="multipart/form-data" class="novalnet_config_form"  action="[{$oViewConf->getSelfLink()}]" method="post">
        ...
        <div class="novalnetCont">
            <div class="novalnet_config_title">
                ...
                <div class="configCnt" style="display:none;" id="global_config">
                    ...
                    <dl>
                        <dd>
                            <input type="hidden" id="novalnet_vendorid" name="aNovalnetConfig[iVendorId]" value="[{$aNovalnetConfig.iVendorId}]" readonly />
                        </dd>
                    </dl>
                    <dl>
                        <dd>
                            <input type="hidden" id="novalnet_authcode" name="aNovalnetConfig[sAuthCode]" value="[{$aNovalnetConfig.sAuthCode}]" readonly />
                        </dd>
                    </dl>
                    <dl>
                        <dd>
                            <input type="hidden" id="novalnet_productid" name="aNovalnetConfig[iProductId]" value="[{$aNovalnetConfig.iProductId}]" readonly />
                        </dd>
                    </dl>
                    <dl>
                        <dt>
                    ...
                    <dl>
                        <dd>
                            <input type="hidden" id="novalnet_accesskey" name="aNovalnetConfig[sAccessKey]" value="[{$aNovalnetConfig.sAccessKey}]" readonly />
                        </dd>
                    </dl>
                    <dl>
                        <dt>
                            <label>[{ oxmultilang ident="NOVALNET_CLIENT_KEY_TITLE" }]</label>
                        </dt>
                        <dd>
                            <input type="text" id="novalnet_clientkey" name="aNovalnetConfig[sClientKey]" value="[{$aNovalnetConfig.sClientKey}]" />
                        </dd>
                    </dl>
                    <dl>
                    ...
                    <dl>
                        ...
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_CALLBACK_ENABLE_MAIL_DESCRIPTION" }]</span>
                        </dd>
                    </dl>
                    <dl>
                        <dt>
            ...
            <div class="novalnet_config_title">
                ...
                <div class="configCnt" style="display:none;" id="creditcard_config">
                     ...
                     <dl>
                       <dt>
                        ...
                        <dd id="payment_action">
                         ...
                         <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_PAYMENT_ACTION_DESCRIPTION" }]</span>
                        </dd>
                    </dl>
                    ...
                    <dl>
                        <dd>
                            <input type="hidden" name="aNovalnetConfig[blCreditcardInlineForm]" value="0" />
                            <input type="checkbox" name="aNovalnetConfig[blCreditcardInlineForm]" id="blCreditcardInlineForm" value="1" [{if !isset($aNovalnetConfig.blCreditcardInlineForm) || $aNovalnetConfig.blCreditcardInlineForm}]checked="checked"[{/if}]/>
                            [{ oxmultilang ident="NOVALNET_CREDITCARD_INLINE_FORM_TITLE" }]
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_CREDITCARD_INLINE_FORM_DESCRIPTION" }]</span>
                        </dd>
                    </dl>
                    <dl>
                        <dd>
                            <input type="hidden" name="aNovalnetConfig[blEnforce3D]" value="0" />
                            <input type="checkbox" name="aNovalnetConfig[blEnforce3D]" value="1" [{if $aNovalnetConfig.blEnforce3D}]checked="checked"[{/if}]/>
                            [{ oxmultilang ident="NOVALNET_CREDITCARD_ENFORCE_3D_TITLE" }]
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_CREDITCARD_ENFORCE_3D_DESCRIPTION" }]</span>
                        </dd>
                    </dl>
                    <dl>
                        <dt>
                    ...
                    <dl>
                     ...
                     <dl>
                        ...
                        <dd>
                            ...
                            <input type="hidden" id="sCreditcardInputForm" value="background-color: #fff; background-image: none; border: 1px solid #ccc; border-radius: 4px; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset; color: #555; display: block; font-size: 14px; height: 34px; line-height: 1.42857; padding: 6px 12px; transition: border-color 0.15s ease-in-out 0s, box-shadow 0.15s ease-in-out 0s;  font-family: inherit; float: left; color: #555;">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>[{ oxmultilang ident="NOVALNET_IFRAME_INPUT_FIELD" }]</td>
                                    <td>
                                        <input type="text" name="aNovalnetConfig[sCreditcardDefaultInput]" id="sCreditcardDefaultInput" value="[{if !isset($aNovalnetConfig.sCreditcardDefaultInput)}][{$sCreditcardInput}][{else}][{$aNovalnetConfig.sCreditcardDefaultInput}][{/if}]" />
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="novalnet_config_title">
                ...
                <dl>
                        ...
                        <dd id="novalnetinvoice_payment_action">
            ...
            <div class="novalnet_config_title">
                ...
                <div class="configCnt" style="display:none;" id="prepayment_config">
                    ...
                    <dl>
                        <dt>
                            <label>[{ oxmultilang ident="NOVALNET_PREPAYMENT_DUE_DATE_TITLE" }]</label>
                        </dt>
                        <dd>
                            <input type="text" name="aNovalnetConfig[iDueDatenovalnetprepayment]" value="[{$aNovalnetConfig.iDueDatenovalnetprepayment}]" />
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_PREPAYMENT_DUE_DATE_DESCRIPTION" }]</span>
                        </dd>
                    </dl>
                    <dl>
                        <dt>
                ...
                <div class="configCnt" style="display:none;" id="paypal_config">
                    <dl>
                     ...
                     <dl>
                        ...
                        <dd id="novalnetpaypal_payment_action">
            ...
            <div class="novalnet_config_title">
             ...
             <div class="novalnet_config_title">
                <span payment_id="alipay_config" onclick="novalnetToggleMe(this)" class="down-icon"></span>
                <b>[{ oxmultilang ident="NOVALNET_ALIPAY" }]</b>
                <div class="configCnt" style="display:none;" id="alipay_config">
                    <dl>
                        <dd>
                            <input type="hidden" name="aNovalnetConfig[blTestmodenovalnetalipay]" value="0" />
                            <input type="checkbox" name="aNovalnetConfig[blTestmodenovalnetalipay]" value="1" [{if $aNovalnetConfig.blTestmodenovalnetalipay}]checked="checked"[{/if}] />
                            [{ oxmultilang ident="NOVALNET_TEST_MODE_TITLE" }]
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_TEST_MODE_DESCRIPTION" }]</span>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="aNovalnetConfig[sBuyerNotifynovalnetalipay]" value="[{$aNovalnetConfig.sBuyerNotifynovalnetalipay}]" />
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_BUYER_NOTIFICATION_DESCRIPTION" }]</span>
                        </dd>
            ...
            <div class="novalnet_config_title">
                <span payment_id="wechatpay_config" onclick="novalnetToggleMe(this)" class="down-icon"></span>
                <b>[{ oxmultilang ident="NOVALNET_WECHATPAY" }]</b>
                <div class="configCnt" style="display:none;" id="wechatpay_config">
                    <dl>
                        <dd>
                            <input type="hidden" name="aNovalnetConfig[blTestmodenovalnetwechatpay]" value="0" />
                            <input type="checkbox" name="aNovalnetConfig[blTestmodenovalnetwechatpay]" value="1" [{if $aNovalnetConfig.blTestmodenovalnetwechatpay}]checked="checked"[{/if}] />
                            [{ oxmultilang ident="NOVALNET_TEST_MODE_TITLE" }]
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_TEST_MODE_DESCRIPTION" }]</span>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="aNovalnetConfig[sBuyerNotifynovalnetwechatpay]" value="[{$aNovalnetConfig.sBuyerNotifynovalnetwechatpay}]" />
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_BUYER_NOTIFICATION_DESCRIPTION" }]</span>
                        </dd>
             ...
             <div class="novalnet_config_title">
                <span payment_id="trustly_config" onclick="novalnetToggleMe(this)" class="down-icon"></span>
                <b>[{ oxmultilang ident="NOVALNET_TRUSTLY" }]</b>
                <div class="configCnt" style="display:none;" id="trustly_config">
                    <dl>
                        <dd>
                            <input type="hidden" name="aNovalnetConfig[blTestmodenovalnettrustly]" value="0" />
                            <input type="checkbox" name="aNovalnetConfig[blTestmodenovalnettrustly]" value="1" [{if $aNovalnetConfig.blTestmodenovalnettrustly}]checked="checked"[{/if}] />
                            [{ oxmultilang ident="NOVALNET_TEST_MODE_TITLE" }]
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_TEST_MODE_DESCRIPTION" }]</span>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="aNovalnetConfig[sBuyerNotifynovalnettrustly]" value="[{$aNovalnetConfig.sBuyerNotifynovalnettrustly}]" />
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_BUYER_NOTIFICATION_DESCRIPTION" }]</span>
                        </dd>
            ...
            <div class="novalnet_config_title">
                <span payment_id="online_bank_transfer_config" onclick="novalnetToggleMe(this)" class="down-icon"></span>
                <b>[{ oxmultilang ident="NOVALNET_ONLINE_BANK_TRANSFER" }]</b>
                <div class="configCnt" style="display:none;" id="online_bank_transfer_config">
                    <dl>
                        <dd>
                            <input type="hidden" name="aNovalnetConfig[blTestmodenovalnetonlinebanktransfer]" value="0" />
                            <input type="checkbox" name="aNovalnetConfig[blTestmodenovalnetonlinebanktransfer]" value="1" [{if $aNovalnetConfig.blTestmodenovalnetonlinebanktransfer}]checked="checked"[{/if}] />
                            [{ oxmultilang ident="NOVALNET_TEST_MODE_TITLE" }]
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_TEST_MODE_DESCRIPTION" }]</span>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="aNovalnetConfig[sBuyerNotifynovalnetonlinebanktransfer]" value="[{$aNovalnetConfig.sBuyerNotifynovalnetonlinebanktransfer}]" />
                        </dd>
                        <dd>
                            <span class="configDesc">[{ oxmultilang ident="NOVALNET_BUYER_NOTIFICATION_DESCRIPTION" }]</span>
                        </dd>
