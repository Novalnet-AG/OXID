            ...
            <table>
                <thead>
                    ...
                    <tr>
                        ...
                        <th>[{ oxmultilang ident="NOVALNET_INSTALMENT_DATE" }]</th>
                ...
                [{assign var="confVarName" value="instalment"|cat:$cycle}]
                    <tr>
                        ...
                        [{else}]
                            <td></td>
                        [{/if}]
                        [{if !empty($aNovalnetInstalmentDetails.$confVarName.paid_date)}]
                            <td>[{$aNovalnetInstalmentDetails.$confVarName.paid_date}]</td>
                        [{else}]
                            <td></td>
                        [{/if}]
                            ...
                            <div id ="refund_box_[{$cycle}]" style ="display:none;">
                                <table style ="border:none;">
                                    <tr>
                                        ...
                                        <td style="border-top:none;"><input type = "text" name ="nn_refund_amount_[{$cycle}]"  id ="nn_refund_amount_[{$cycle}]" value ="[{$oViewConf->getNovalnetInstalmentAmount($aNovalnetInstalmentDetails.$confVarName.amount)}]" onkeypress="return isValidExtensionKey(event);"></td>
                                    </tr>
                                    <tr>
                    ...
                    [{if $aNovalnetInstalmentDetails.$confVarName.status == 'NOVALNET_INSTALMENT_STATUS_REFUNDED'}]
                        [{assign var=in_refund value=1}]
                    [{/if}]
                [{/foreach}]
                <tr>
                    ...
                    <td style="border-top:none;">
                        [{if $in_refund == 0}]
                            <button type="button" name ="all_instalment_cancel" id ="all_instalment_cancel" class="btn btn-primary btn-sm" onclick ="return cancelAllInstalment([{$aNovalnetInstalmentDetails.instalment1.tid}]);" style="display:none;">[{ oxmultilang ident="NOVALNET_INSTALMENT_CANCEL_ALL_CYCLE" }]</button>
                        [{/if}]
                    </td>
                    <td style="border-top:none;" style="text-align:right;">
                        [{if $in_refund == 0 || $bHideRemainingCancel != 1}]
                        ...
                        [{if $bHideRemainingCancel != 1 }]
                            <button type="button" name ="remaining_instalment_cancel" id ="remaining_instalment_cancel" class="btn btn-primary btn-sm" onclick ="return cancelRemainingInstalment([{$aNovalnetInstalmentDetails.instalment1.tid}]);" style="display:none;" >[{ oxmultilang ident="NOVALNET_INSTALMENT_CANCEL_REMAINING_CYCLE" }]</button>
                        [{/if}]
                    </td>
                    [{else}]
                    <td style="border-top:none;"></td>
