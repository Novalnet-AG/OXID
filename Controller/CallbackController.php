...
class CallbackController extends FrontendController
{
    ...
    private function _processNovalnetCallback()
    {
        ...
        if ($iPaymentTypeLevel === 0) {
            ...
            }  elseif (in_array($this->_aCaptureParams['payment_type'], ['INVOICE_START', 'GUARANTEED_INVOICE', 'GUARANTEED_DIRECT_DEBIT_SEPA', 'DIRECT_DEBIT_SEPA', 'CREDITCARD']) &&  in_array($this->_aCaptureParams['tid_status'], ['91', '98', '99', '100']) && in_array($this->aOrderDetails['GATEWAY_STATUS'], ['75','91','98','99'])) {
                     $sNovalnetComments = '';
                     $sMessage = '';
