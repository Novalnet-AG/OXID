...
class OrderController extends OrderController_parent
{
    ...
    public function novalnetGatewayReturn()
    {
        ...
        if (in_array($sKey, ['6', '33', '34', '49', '50', '69', '78', '110', '115', '116', '113']) || ($oConfig->getRequestParameter('payment_type'))) {            
            $sInputVal3                   = $oConfig->getRequestParameter('inputval3');
            $sInputVal4                   = $oConfig->getRequestParameter('inputval4');
            $sInputVal5                   = $oConfig->getRequestParameter('inputval5');
            ...
            $_POST['sDeliveryAddressMD5'] = ($sInputVal5) ? $sInputVal5 : $_POST['sDeliveryAddressMD5'];
