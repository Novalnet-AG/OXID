...
$aModule = [
    ...
    'extend'      => [   \OxidEsales\Eshop\Application\Controller\PaymentController::class        => \oe\novalnet\Controller\PaymentController::class,
                         ...
                         \OxidEsales\Eshop\Core\UtilsServer::class                                => \oe\novalnet\Core\UtilsServer::class,
    ...
    'blocks'      => [
                                ...
                                [   'theme'    => 'flow',
                                    'template' => 'page/account/order.tpl',
                                    'block'    => 'account_order_history',
                                    'file'     => '/views/blocks/page/account/novalnetorder_flow.tpl'
                                ],
                                [  'theme'     => 'azure',
                                    'template' => 'page/account/order.tpl',
                                    'block'    => 'account_order_history',
                                    'file'     => '/views/blocks/page/account/novalnetorder_azure.tpl'
                                ],
                                [   'theme'    => 'wave',
                                    'template' => 'page/account/order.tpl',
                                    'block'    => 'account_order_history',
                                    'file'     => '/views/blocks/page/account/novalnetorder_wave.tpl'
                                ],
                                ...
                                [   'template' => 'page/checkout/payment.tpl',
										...
										'file'     => '/views/blocks/page/checkout/novalnetpaymenterrors.tpl',
									],
